...
# Dates for the tentative schedule at the end (so you don't have to manually)
# type each date year after year.
start_date <- as.Date("2021-09-09") # Date of the first lab.

dates <- format(start_date + 7 * 0:12, "%b. %d")
...
|Week |Date           |Topic                                                |
|:---:|:--------------|:----------------------------------------------------|
|1    |`r dates[[1]]` |Introduction to R                                    |
|2    |`r dates[[2]]` |Introduction to R, part 2                            |
|3    |`r dates[[3]]` |Data visualisation with ggplot2                      |
|4    |`r dates[[4]]` |National Day for Truth and Reconciliation. No Lab.   |
|5    |`r dates[[5]]` |Quiz 1                                               |
|5    |`r dates[[6]]` |One sample *t* test                                  |
|6    |`r dates[[7]]` |Paired samples *t* test                              |
|7    |`r dates[[8]]` |Independent samples *t* test                         |
|8    |`r dates[[9]]` |Correlation                                          |
|10   |`r dates[[10]]`|Midterm Break                                        |
|11   |`r dates[[11]]`|ANOVA                                                |
|12   |`r dates[[12]]`|Factorial ANOVA                                      |
|13   |`r dates[[13]]`|Final Quiz                                           |
